...
In the coin example, the probability of heads is 50% but at -110, the implied probability is actually 52.4%.
This is because sportsbooks charge a fee or "vig" for placing bets, which makes the implied probability higher than the actual probability.
This is how sportsbooks make money: _bets typically cost more than they should_.
