...
possible combinations. Assuming the password could be 25 digits long, it would take billions
of years to come up with a valid guess - even if you used a room full of expensive
computers.
