...
Betting odds are complicated on purpose. Look no further than "moneyline" odds, which like
Fahrenheit are 1) only used in the US and 2) confuse everyone else.

I had trouble describing in a single sentence:
...
> Moneyline odds are also called _American odds_.
...
Because _The House always wins_, casinos and sportsbooks would give you -110 odds to pick
either side, or "$110 to win $100".
...
Here's an example of an "even" game on Draftkings, where you can bet on the Bills or the
Rams to win (moneyline), both giving you -110 odds:
...
> I'm sure there's an argument why the moneyline odds (+260, -180, etc) betting syntax makes
> more sense, but in reality it's just another way that casinos try to distract you from the
> amount of money you're losing.
...
- **Moneyline/American**:
  ...
  - Nevative: How much money must be wagered to win $100.
...
<GrayBox>
  **For example**: <br />
  ...
  1/4 odds is "$100 to win $25", or 1.25 in decimal. This would be -400 in freedom units.
</GrayBox>
...
basically searching for American odds if it's `active`, otheriwse it's looking for the
