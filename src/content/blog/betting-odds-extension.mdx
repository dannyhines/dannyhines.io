...
Because _The House always wins_, the odds are set at -110 for either side, or "$110 to win $100".
...
time. When it's -110, or worse something like _+350 to win the Super Bowl_, it's difficult to
know if you're getting a "fair" price.

> I'm sure there's an argument why the moneyline odds betting syntax makes
