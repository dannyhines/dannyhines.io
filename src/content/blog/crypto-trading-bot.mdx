---
title: 'Crypto Twitter Automated Trading Bot'
description:
...
<HeaderImage
  src='/images/crypto-trading-bot/header.png'
...
I'm not a big crypto guy. I'll start there, because although I love the idea of
[Bitcoin](https://bitcoin.org/bitcoin.pdf) and the possibilities of the blockchain, I simply
can't fathom why it's worth what it is. Pricing Bitcoin or any cryptocurrency is difficult
because there's no basis for it. That is, it doesn't produce anything. There is no CEO, no
revenue, no cash flows, and there ever-present threat of the
...
But that doesn't mean that you can't profit off of it. And even if I'm unsuccessful, trading
crypto still sounds like a fun way to lose money.

Because it's ‘wild wild west', crypto is crazy volatile. Because there's no company to
analyze or a market to compare it to, the market is dominated by hype and FOMO. In general,
those who have made the most on crypto are those who bought early, ~~because it's basically
a ponzi scheme~~ and the price of a crypto token goes up as word spreads across the
internet.

The economist and _father of value investing_ Ben Graham said, "In the short run, the market
is a voting machine but in the long run it is a weighing machine.” Recently, it feels like
markets have voted for Elon Musk.
...
time, and its market cap is so large that any news story will be lost in the tsunami of
bitcoin-related tweets. So I'm going to look for influencers tweeting about altcoins, and
see if I can buy before crypto twitter does.

## Twitter has a free API, right?
...
query space if I wanted to search for every
...
<Image
  src='/images/crypto-trading-bot/tweet-flow-chart.png'
...
<Image
  src='/images/crypto-trading-bot/backtesting-jan-22.png'
