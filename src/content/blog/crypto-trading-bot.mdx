...
Crypto is the Wild Wild West of the finance industry. Because there's no company to analyze
or a market to compare it to, the market is dominated by hype and FOMO. In general, those
who have made the most on crypto are those who bought early, ~~because it's basically a
ponzi scheme~~ and the price of a crypto token goes up as word spreads across the internet.

The _father of value investing_ Ben Graham once said, "In the short run the market is a
voting machine, but in the long run it is a weighing machine.” It's probably too early to
tell the weight of crypto, but I know the markets have voted for Elon Musk.
...
time, and its market cap is so large that any news story will be a small blip compared to
the tsunami of bitcoin-related tweets. So I'm going to look for influencers tweeting about
altcoins, and see if I can buy before crypto twitter does.
